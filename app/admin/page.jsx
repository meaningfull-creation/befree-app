...
async function getCounts() {
  const [companies, talents, companySkillMaps, talentSkillMaps, matches, engagements, newInquiries, pendingContracts] = await Promise.all([
  ...
  return { companies, talents, companySkillMaps, talentSkillMaps, matches, engagements, newInquiries, pendingContracts };
}
  ...
  return (
    <AdminShell current="dashboard">
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 8 }}>
        ...
        <StatCard label="人材の回答待ちの契約提案" value={c.pendingContracts} />
      </div>
