...
const SECTIONS = [
  {
    title: "1. 収集する情報",
    body: `当社は、本サービスの提供にあたり、以下の情報を取得します。(1)企業ユーザー: 会社名、業種・業界、従業員数、外部資本の有無、成長段階、年商、AI課題診断の対話内容。(2)実務経験者ユーザー: 氏名、メールアドレス、直近の役職、業種経験、実務経験年数、職務経歴・プロジェクト実績。(3)共通: メールアドレス、パスワード(ハッシュ化して保存)、本サービス上でのメッセージ内容、利用ログ。`,
  },
  {
    title: "2. 利用目的",
