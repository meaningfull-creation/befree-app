...
// 支払いフローは 企業→BeFree→人材 を前提とし、企業⇄BeFree・BeFree⇄人材の2本の業務委託契約として扱う。
...
// 企業→BeFreeへの請求書を発行する(決済導線の土台。実際の入金確認は未実装)。
...
// BeFree→人材への支払いを起票する(企業からの入金確認後に実施する想定)。
