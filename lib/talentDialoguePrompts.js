...
「本人が申告した具体的な経験業務」は、どの軸のどの部分を実際にやってきたかを示す最も強い手がかりです。対話の内容と一致するほど、該当軸のスコアを高くしてください。
...
- evidence: スコア上位5軸について、なぜその点数にしたかの根拠を { "軸キー": "対話や申告内容のどこを根拠にしたかを30〜60字で具体的に" } の形でまとめる。推測で補った場合は「経歴からの推定」と明記すること
