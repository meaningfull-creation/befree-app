...
// 5ターン(15→6→10の変遷を経てv5.5で5に短縮)。
// 登録までの離脱を防ぐため、最初の対話は最小限にとどめ、詳細はスキルマップ表示後の
// 「項目ごとの深掘り」(app/api/diagnosis/axis-deep-dive)で軸ごとに詰めていく方針に変更した。
// 人材側(MAX_TALENT_DIALOG_TURNS)と同じ問数に揃えている。
